"""Generate both copies of the RTI_012 notebook from a single source.

Outputs:
  Raw/RTI_Notebooks/RTI_012_build_basic_telemetry_dashboard.ipynb          (readable copy)
  Notebooks/RTI_012_build_basic_telemetry_dashboard.Notebook/              (Fabric git item)
...
file always wins over the seed, so the download-and-replace redesign loop still works.
    ...
    python Raw/RTI_Notebooks/tools/build_rti_012.py            # regenerate
    python Raw/RTI_Notebooks/tools/build_rti_012.py --check    # fail if out of date
"""
...
NOTEBOOK_NAME = "RTI_012_build_basic_telemetry_dashboard"
LOGICAL_ID = "6d2f0f1a-6c1e-4f6e-9a2b-3c9d5e7f1a24"

DEFINITION_FILE = REPO / "Raw" / "RTI_Notebooks" / "dashboards" / f"{DASHBOARD_NAME}.json"
...
MD_INTRO = """# 12 — Provision the Basic Hydro Telemetry Real-Time Dashboard
...
PLATFORM = json.dumps(
    {
        ...
        "metadata": {
            ...
            "description": "Provisions the basic hydro telemetry Real-Time Dashboard from a definition file.",
        },
