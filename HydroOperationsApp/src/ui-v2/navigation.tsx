import { Activity, Bot, CloudSun, Factory, Gauge, Settings, Wrench } from 'lucide-react'
...
export type V2TabId = 'overview' | 'telemetry' | 'weather' | 'digital-twin' | 'copilot' | 'maintenance' | 'administration'
