...
export function V1Shell() {
  return <HydroOperationsDataProvider><ExplorerModeProvider><V1ShellContent /></ExplorerModeProvider></HydroOperationsDataProvider>
}
